...
function AppWithReducers() {
    ...
    let [todolists, dicpatchToTodolistReducer] = useReducer(todolistsReducer,[
    ...
    function changeFilter(value: FilterValuesType, todolistId: string) {
        dicpatchToTodolistReducer(changeTodolistFilterAC(todolistId,value))
    }
    function removeTodolist(id: string) {
        dicpatchToTodolistReducer(removeTodolistAC(id))
        dispatchToTaskReducer(removeTodolistAC(id))
    }
    function changeTodolistTitle(id: string, title: string) {
        dicpatchToTodolistReducer(changeTodolistTitleAC(id,title))
    }
    function addTodolist(title: string) {
        const action=addTodolistAC(title)
        dispatchToTaskReducer(action)
        dicpatchToTodolistReducer(action)
    }
    return (
        <div className="App">
